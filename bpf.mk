...
build:
	...
	go-bindata -pkg straceback -prefix "${DEST_DIR}/" -modtime 1 -o "${DEST_DIR}/straceback-assets-bpf.go" "${DEST_DIR}/straceback-main-bpf.o" "${DEST_DIR}/straceback-tailcall-bpf.o"
